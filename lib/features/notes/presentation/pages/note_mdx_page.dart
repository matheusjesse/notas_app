...
class _NoteMdxPageState extends State<NoteMdxPage> {
  ...
  NoteModel? _currentNote; // Adicionar nota atual para manter os dados atualizados
  ...
  Future<void> _saveNote() async {
    ...
    String content = _controller.text; // Preservar o conteúdo original integralmente
  ...
  Widget build(BuildContext context) {
    ...
    ? TextField(
        ...
        decoration: const InputDecoration(
          hintText: "Digite sua nota em MDX...\n\nDica: Use # para títulos\n- [ ] para checkboxes",
          border: InputBorder.none,
        ),
        onChanged: (value) {
          setState(() {}); // Atualiza o título na AppBar quando o conteúdo muda
        },
      )
